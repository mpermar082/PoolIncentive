// src/lib.rs
/*
 * Core library for PoolIncentive
 */
...
#[derive(Debug)]
pub struct PoolIncentiveProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PoolIncentiveProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PoolIncentive processing");
    
    let mut processor = PoolIncentiveProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PoolIncentiveProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PoolIncentiveProcessor::new(false);
